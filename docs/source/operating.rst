[NetworkAnalyticsProject1-8c73] Operating Details
====================================

Generated On: 2024-10-17 20:06:28 UTC
...
.. important::
   ...
   **not be valid if your [NetworkAnalyticsProject1-8c73] container is NOT running**.

.. tip::
   You must have your [NetworkAnalyticsProject1-8c73] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Parameshreddy1995/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=44025  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Parameshreddy1995'  \-\-env DOCKERUSERNAME='parameshreddy1995'  \-\-env MQTTUSERNAME='parameshreddy995@gmail.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   parameshreddy1995/NetworkAnalyticsProject1-8c73-amd64 (https://hub.docker.com/r/parameshreddy1995/NetworkAnalyticsProject1-8c73-amd64)
...
.. important::
   docker run -d -p 46207:46207 -p 36957:36957 -p 33129:33129 \-\-env TSS=0 \-\-env SOLUTIONNAME=NetworkAnalyticsProject1-8c73 \-\-env SOLUTIONDAG=solution_preprocessing_dag_mqtt-NetworkAnalyticsProject1-8c73 \-\-env GITUSERNAME=Parameshreddy1995  \-\-env GITREPOURL=https://github.com/Parameshreddy1995/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=46207  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=36957  \-\-env SOLUTIONVIPERVIZPORT=33129 \-\-env DOCKERUSERNAME='parameshreddy1995'  \-\-env EXTERNALPORT=44025 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='parameshreddy995@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  parameshreddy1995/NetworkAnalyticsProject1-8c73-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=33129
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=46207
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - parameshreddy1995/NetworkAnalyticsProject1-8c73-amd64
...
It can be accessed by entering: http://localhost:36957
...
.. important::
   http://localhost:33129/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:33129/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:33129/<html file>
...
[NetworkAnalyticsProject1-8c73] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Parameshreddy1995/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/NetworkAnalyticsProject1-8c73
...
.. important::
   https://NetworkAnalyticsProject1-8c73.readthedocs.io
...
.. important::
   solution_preprocessing_dag_mqtt-NetworkAnalyticsProject1-8c73
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=46207, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=35757, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=41085, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=34055, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=43563, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=37599, HPDEHOST=127.0.1.1, HPDEPORT=39171, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=42471

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-3942-NetworkAnalyticsProject1-8c73,solution_preprocessing_dag_mqtt-NetworkAnalyticsProject1-8c73, python-preprocess-8053-NetworkAnalyticsProject1-8c73,solution_preprocessing_dag_mqtt-NetworkAnalyticsProject1-8c73, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
